...
let ProjectsController = class ProjectsController {
    ...
    findAll(pagination, status, user) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List projects for the current tenant' }),
    (0, swagger_1.ApiQuery)({ name: 'status', enum: project_entity_1.ProjectStatus, required: false }),
