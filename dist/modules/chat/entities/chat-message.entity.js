...
let ChatMessage = class ChatMessage {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, role: { required: true, enum: require("./chat-message.entity").MessageRole }, content: { required: true, type: () => String }, sessionId: { required: true, type: () => String }, session: { required: true, type: () => require("./chat-session.entity").ChatSession }, tenantId: { required: true, type: () => String }, metadata: { required: true, type: () => Object, nullable: true }, createdAt: { required: true, type: () => Date } };
    }
};
